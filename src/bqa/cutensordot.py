...
def get_tensordot_subscripts(lhs_rank: int, rhs_rank: int, axes: list[list[int]]) -> str:
...
try:
    ...
    def batch_cutensordot(lhs_tensor, rhs_tensor, axes: list[list[int]] | int):
        ...
        subscripts = get_tensordot_subscripts(lhs_rank, rhs_rank, desug_axes)
